      ...
      <div className="hero-wrapper">
        ...
        <div className="hero-bottom">
          ...
          <div className="hero-bottom-left">
            <span className="hero-bottom-left-text">Days</span>
            <br />
            <span className="hero-bottom-left-number">{days()}</span>
            <span className="hero-bottom-left-text">Left</span>
            <div className="teams-button">
              <a href="assets/teams.xlsx" download="Shortlisted_Teams.xlsx">
                Shortlisted Teams
              </a>
            </div>
          </div>
            ...
            <div className="hero-bottom-right-container">
              <MagneticEffect>
                <div className="hero-bottom-right-register-btn">
                  <a
                    href="https://unstop.com/hackathons/international-innovation-challengehackathon-manipal-university-jaipur-1174688?lb=CtnnOKei"
                    className="hero-right-btn-link"
                  >
                    {" "}
                    Register Now{" "}
                  </a>
              ...
              <div className="hero-bottom-right-about">
                <span>About</span>
                <p>
                  The International Innovation Challenge (IIC) is a premier
                  global hackathon that brings together bright minds from top
                  universities to solve real-world industry challenges.
                  Organized by Manipal University in collaboration with other
                  key partners, IIC focuses on critical areas like
                  cybersecurity, sustainability, and digital transformation.
                </p>
              </div>
            </div>
          </div>
