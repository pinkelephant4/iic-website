    ...
    <div>
      ...
      <div className="CampusLast-container">
        <div className="CampusLast-box">
          ...
          <p>
            Top 1-2 ambassadors will get the change to incubate at Atal
            Incubation Center
          </p>
        </div>
        <div className="CampusLast-box">
      ...
      <h1 className="CampusLast-Heading">
        You are just 3 Steps away from <br></br> becoming a part of this journey{" "}
      </h1>
      ...
      <div className="vertical-box-container">
        <div className="vertical-box">
          ...
          <p className="vertical-para">
            Fill in your details and register yourself
          </p>
        </div>
        ...
        <div className="vertical-box">
          ...
          <p className="vertical-para">
            You will receive a referral code for promotion
          </p>
        </div>
      </div>
    </div>
